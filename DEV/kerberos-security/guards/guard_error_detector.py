...
# -*- coding: utf-8 -*-
"""
🔍 Guard Error Detector — Détecteur d'erreurs Python avec GUI Tkinter
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
- Détection erreurs syntaxe (ast)
- Détection erreurs d'import
- Vérification code quality (PEP8 basique)
- Interface Tkinter dark theme (style Kerberos)
...
"""
# ============================================================================
#  KERBEROS ULTIMATE v4.2 — Guard Error Detector
...
<head>
    <meta charset="UTF-8">
    <title>Rapport Error Detector — {datetime.now().strftime('%Y-%m-%d %H:%M')}</title>
    <style>
...
class ErrorDetectorGUI:
    ...
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("🔍 Kerberos Error Detector — Analyseur Python")
    ...
    def _setup_ui(self):
        ...
        tk.Label(header, text="🔍 KERBEROS ERROR DETECTOR",
                bg='#16213e', fg='#00ffcc',
        ...
        tk.Label(footer, text="GPLv3 • Victor Pozen • Kerberos v4.2",
                bg='#16213e', fg='#607d8b',
    ...
    def _scan_thread(self, path: str):
        try:
            ...
            _publish_metric(1.0 if self.detector.files_error > 0 else 0.2)
...
# === POINTS D'ENTRÉE ========================================================
# ============================================================================
_gui_instance: Optional[ErrorDetectorGUI] = None

def start_guard():
    """Point d'entrée pour Kerberos"""
    global _gui_instance
    print("🔍 [Error Detector] Guard chargé — prêt pour analyse")
    _publish_metric(0.1)
    return None
...
def get_stats() -> Dict:
    ...
    return {
        "guard_name": "Error Detector",
        "status": "active",
        "description": "Détection erreurs Python (syntaxe, imports, quality)",
    }

def run_gui():
    """Lance l'interface graphique"""
    global _gui_instance
    _gui_instance = ErrorDetectorGUI()
    _gui_instance.run()

def run_cli(directory: str = "."):
    """Lance en ligne de commande"""
    detector = PythonErrorDetector()
    report = detector.scan_directory(Path(directory))
    
    print("\n" + "="*60)
    print("🔍 RAPPORT ERROR DETECTOR")
    print("="*60)
    print(f"📊 Fichiers scannés: {report['files_scanned']}")
    print(f"✅ Fichiers OK: {report['files_ok']}")
    print(f"🔴 Erreurs: {report['files_error']}")
    ...
    if report['warnings']:
        print("\n🟠 WARNINGS:")
        for warn in report['warnings'][:10]:  # Limite à 10
            print(f"   • {warn['file']}")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="🔍 Kerberos Error Detector")
    parser.add_argument("directory", nargs="?", default=".",
                       help="Dossier à scanner")
